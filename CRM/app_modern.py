...
<section class="hero-shell">
  <div class="hero-left">
    <div class="eyebrow">Interactive CRM Analytics</div>
    <h1>From Data<br>to Decisions</h1>
    <p>Explore customer sales data, uncover CRM insights, predict sales outcomes, and convert analysis into marketing actions.</p>
  </div>
  ...
  <div class="flow-grid">
    <div class="flow-item">
      ...
      <h3>Customer Data</h3>
      <p>Clean sales, product, customer, and territory data.</p>
    </div>
    <div class="flow-arrow">→</div>
    <div class="flow-item">
      <div class="flow-icon">⌕</div>
      <h3>EDA</h3>
      <p>Explore revenue, cost, quantity, and customer activity.</p>
    </div>
    <div class="flow-arrow">→</div>
    <div class="flow-item warm">
      <div class="flow-icon">◎</div>
      <h3>CRM Insight</h3>
      <p>Find high-value products, customers, and territories.</p>
    </div>
    <div class="flow-arrow">→</div>
    <div class="flow-item">
      <div class="flow-icon">↗</div>
      <h3>Prediction</h3>
      <p>Use ML models for classification and regression.</p>
    </div>
    <div class="flow-arrow">→</div>
    <div class="flow-item warm">
      <div class="flow-icon">✈</div>
      <h3>Marketing Action</h3>
      <p>Turn model outputs into CRM recommendations.</p>
    </div>
  </div>
</section>
"""
...
<div class="section-head">
  <div>
    ...
    <h2>Data Check / Preprocessing</h2>
    <p>The original sales dataset was cleaned and transformed into a modeling-ready table. Date keys were converted into Year, Month, and YearMonth. Profit was calculated as Sales Amount − Total Product Cost.</p>
  </div>
</div>
...
<div class="section-head">
  <div>
    ...
    <p>The project connects data analysis with CRM decision-making. The goal is not only to show charts, but to support concrete marketing actions.</p>
  </div>
</div>
...
/* Stretch Gradio tabs across the full dashboard width. */
.gradio-container,
...
"""
    ...
    with gr.Tab("KPI"):
        gr.HTML('<div class="section-head"><span class="eyebrow">Business Size</span><h2>KPI Dashboard</h2><p>These indicators summarize the business scale, sales volume, customer base, and profit.</p></div>')
    ...
    with gr.Tab("EDA"):
        gr.HTML('<div class="section-head"><span class="eyebrow">Visual Analysis</span><h2>Exploratory Data Analysis</h2><p>Use these charts to understand revenue concentration, product performance, customer activity, and monthly sales trends.</p></div>')
    ...
    with gr.Tab("Insights"):
        gr.HTML('<div class="section-head"><span class="eyebrow">CRM Insight</span><h2>Customer / Product Insight</h2><p>These tables identify the most important customers, products, and sales territories for CRM decision-making.</p></div>')
    ...
    with gr.Tab("Prediction"):
        gr.HTML('<div class="section-head"><span class="eyebrow">Machine Learning</span><h2>Prediction Models</h2><p>Classification supports CRM targeting. Regression supports sales forecasting and planning.</p></div>')
        with gr.Row():
    ...
    with gr.Tab("Custom Prediction"):
        gr.HTML('<div class="section-head"><span class="eyebrow">Scenario Testing</span><h2>Custom Sales Prediction</h2><p>Enter transaction conditions and estimate the expected sales amount.</p></div>')
        with gr.Row():
